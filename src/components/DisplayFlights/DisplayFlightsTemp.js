                            ...
                            !sortedLoading && flightsData != null && flightsData.itineraries.map((itr) => (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        (!expanded ? <Stack direction={'row'} sx={{ py: 2, width: '100%' }}>
                                                ...
                                                leg.segments.map((seg) =>
                                                    <Stack direction={'row'}>
                                                        <Grid container sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                                                            ...
                                                            <Grid item sm={11.5} sx={{ borderBottom: '1px solid lightgray', borderTop: '1px solid lightgray', display: 'flex', justifyContent: 'flex-start', alignItems: 'center' }}>
                                                                <Box sx={{ py: 2 }} >
                                                                    <Box>
                                                                        <Typography sx={{ fontSize: 14, color: '#70757a' }} >3 hr 40 min layoverHyderabad (HYD)</Typography>
                                                                    </Box>
                                                                </Box>
                                                            </Grid>
                                                        </Grid>
