const FaqData = [
    {
        id: 1,
        ques: 'How can I find last-minute flight deals?',
        ans: `Finding last-minute flights is easy on Google Flights.
...
To find the cheapest fares, it’s usually best to book at least a few weeks in advance for domestic flights and a few months in advance for international travel.` },
    {
        id: 2,
        ques: 'How can I find cheap flights for a weekend getaway?',
        ans: `It’s easy to use Google Flights to find deals on weekend getaways or even weeklong trips.
...
You can also turn on price tracking to get alerts if the price changes for a route or flight.` },
    {
        id: 3,
        ques: 'How can I find flight deals if my travel plans are flexible?',
        ans: `It’s easy to search for flights, even if your plans are up in the air.
...
Price insights and other useful tools can help you find more options that work for your schedule and budget.` },
    {
        id: 4,
        ques: 'How can I find cheap flights to anywhere?',
        ans: `You can find cheap flight deals to anywhere in the world on Google Flights. Just enter your departure city, choose Anywhere as the destination, and select Explore.
...
You can filter the results to see only nonstop flights or flights under a certain price to more easily plan your perfect budget trip.`
    ...
    { id: 5, ques: 'How can I get flight alerts for my trip?', ans: 'You can track flight prices for specific dates or, if your plans are flexible, any dates. To get flight alerts for a specific round trip, choose your dates and flights and select Search. Then, you can turn on price tracking.' },
]
